...
var themes={
  green:{id:'green',name:'翠绿',accent:'#22c55e',accent2:'#15803d',accent3:'#166534',bg:'#06080d',canvasBg:'#0b0e16',border:'#16422a',gridDot:'#0e111a',glow:'34,197,94',snakeH:[22,197,94],snakeT:[37,74,89],particleH:22,deathP:'#4ade80',popup:'#4ade80'},
  blue:{id:'blue',name:'海蓝',accent:'#3b82f6',accent2:'#1d4ed8',accent3:'#1e3a5f',bg:'#050914',canvasBg:'#0a0f1c',border:'#182a4a',gridDot:'#0c1120',glow:'59,130,246',snakeH:[37,130,246],snakeT:[25,50,100],particleH:210,deathP:'#60a5fa',popup:'#60a5fa'},
  purple:{id:'purple',name:'紫霞',accent:'#a855f7',accent2:'#7c3aed',accent3:'#4c1d95',bg:'#08050e',canvasBg:'#0e0b18',border:'#291a44',gridDot:'#100c1c',glow:'168,85,247',snakeH:[140,70,220],snakeT:[50,20,100],particleH:270,deathP:'#c084fc',popup:'#c084fc'},
  gold:{id:'gold',name:'金芒',accent:'#f59e0b',accent2:'#b45309',accent3:'#78350f',bg:'#0c0802',canvasBg:'#120e08',border:'#3d2407',gridDot:'#14100a',glow:'245,158,11',snakeH:[245,180,20],snakeT:[100,60,10],particleH:35,deathP:'#fbbf24',popup:'#fbbf24'}
};
...
var snake,food,dir,nextDir,score,best,speed,minSpeed,accel,timer,paused,gameOver,boosting=false;
...
function init(){
  ...
  score=0;foodEaten=0;specialFood=null;foodHidden=false;paused=gameOver=false;boosting=false;
  ...
  applyTheme();updateLabels();spawnFood();draw();
}
...
function step(){
  ...
  draw();
  var delay=boosting?Math.max(speed-40,40):speed;timer=setTimeout(step,delay);
}
...
function startGame(){window.Sfx.init();started=true;startMenu.classList.add('hidden');pauseBtn.classList.remove('hidden');init();window.Sfx.start();timer=setTimeout(step,speed)}
function backToMenu(){clearTimeout(timer);init();started=false;gameOverEl.classList.add('hidden');pauseOverlay.classList.add('hidden');pauseBtn.classList.add('hidden');startMenu.classList.remove('hidden');renderLB();draw()}
